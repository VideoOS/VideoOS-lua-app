	...
	Cell = {
		...
		ImageAndLabel = {
			...
			Init = function(cell)
				...
				cell.titlexh = Label();
				cell.titlexh:frame(0, cellHeight+2+45, cellHeight, 40);
				cell.titlexh:textColor(0xffFFFF);
				cell.titlexh:backgroundColor(0xff00ff);
				print("构造Cell--2");
			end,
			Layout = function(cell , section, row)
				...
				cell.titlexh:text("xh"..section .."--" .. row);
