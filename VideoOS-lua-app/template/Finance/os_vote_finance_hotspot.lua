...
local function onCreate(args)
    ...
    vote.voteImage:onClick(function()
        ...
        Native:sendAction(Native:base64Encode("LuaView://defaultLuaView?template=" .. "os_vote_finance_window.lua" .. "&id=" .. "os_vote_finance_window" .. tostring(vote.id) .. "&priority=2"), args)
    end)
