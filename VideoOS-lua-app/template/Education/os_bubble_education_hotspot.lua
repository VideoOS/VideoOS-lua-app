...
local OS_BUBBLE_LEFT_IMAGE = ""
...
local function createUserTypeLeftWithMessageText(data, index) --左边用户云泡 显示问题
    ...
    message:textSize(12)
    message:backgroundColor("os_education_message_left_bg")
...
function createUserMessageSelect(data, index) --左边用户云泡 显示问题
    ...
    if System.ios() then
        selectLeftView:gradient(0x286BF9, 1.0, 0x286BF9, 1.0, 0.0, 0.5, 1.0, 0.5)
    else
        selectLeftView:gradient(0x286BF9, 1.0, 0x286BF9, 1.0, Orientation.LEFT_RIGHT)
    end
    ...
    if System.ios() then
        selectRightView:gradient(0x286BF9, 1.0, 0x286BF9, 1.0, 0.0, 0.5, 1.0, 0.5)
    else
        selectRightView:gradient(0x286BF9, 1.0, 0x286BF9, 1.0, Orientation.LEFT_RIGHT)
    end
