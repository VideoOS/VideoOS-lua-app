...
local OS_BUBBLE_LEFT_IMAGE = ""
...
local function createUserTypeLeftWithMessageText(data, index) --左边用户云泡 显示问题
    ...
    message:textSize(12)
    message:backgroundColor("os_sports_message_left_bg")
...
local function createUserTypeRightWithMessageImage(data, index) --左边用户云泡 显示问题
    ...
    message:margin(86 * bubble.scale, 19 * bubble.scale, 11 * bubble.scale, 0)
    if data.link ~= nil and string.match(tostring(data.link), "http") == "http" then
        performWithDelay(function()
            prompt:show()
            startViewMoveAnim(prompt, prompt:width() * 0.3, -prompt:height() * 0.3, nil)
...
local function createScrollView(data)
    ...
    if (System.android()) then
        scrollview:padding(7 * bubble.scale, 0, 2 * bubble.scale, 0)
    end
...
function createUserMessageSelect(data, index) --左边用户云泡 显示问题
    ...
    if (System.ios()) then
        ...
        userParent = View()
        userParent:padding(0, 0, 0, 15 * scale)
    end

    local selectLeftView = GradientView()
    selectLeftView:frame(31 * scale, 18 * scale, 72 * scale, 24 * scale)
    if System.ios() then
        selectLeftView:gradient(0x24C689, 1.0, 0x24C689, 1.0, 0.0, 0.5, 1.0, 0.5)
    else
        selectLeftView:gradient(0x24C689, 1.0, 0x24C689, 1.0)
    end
    ...
    selectRightView:frame(107 * scale, 18 * scale, 72 * scale, 24 * scale)
    if System.ios() then
        selectRightView:gradient(0x24C689, 1.0, 0x24C689, 1.0, 0.0, 0.5, 1.0, 0.5)
    else
        selectRightView:gradient(0x24C689, 1.0, 0x24C689, 1.0)
    end
