...
function createUserMessageSelect(data, index) --左边用户云泡 显示问题
    ...
    if System.ios() then
        selectLeftView:gradient(0xF51D56, 1.0, 0xF9B223, 1.0, 0.0, 0.5, 1.0, 0.5)
    else
        selectLeftView:gradient(0xF51D56, 1.0, 0xF9B223, 1.0,Orientation.LEFT_RIGHT)
    end
    ...
    if System.ios() then
        selectRightView:gradient(0xF51D56, 1.0, 0xF9B223, 1.0, 0.0, 0.5, 1.0, 0.5)
    else
        selectRightView:gradient(0xF51D56, 1.0, 0xF9B223, 1.0,Orientation.LEFT_RIGHT)
    end
